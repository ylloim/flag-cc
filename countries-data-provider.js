...
if (!CountriesDataProvider.data) {
  CountriesDataProvider.data = {
    ...
    currencies: {
      ...
      'XAU': {name: 'Gold (one troy ounce)', currency: 'XAU', flag: ''},
      'XDR': {name: 'Special drawing rights', currency: 'XDR', flag: ''},
      'XAG': {name: 'Silver (one troy ounce)', currency: 'XAG', flag: ''},
      'XPT': {name: 'Platinum (one troy ounce)', currency: 'XPT', flag: ''},
      'XTS': {
        name: 'Code reserved for testing purposes',
        currency: 'XTS',
        flag: '',
      },
      'XPD': {name: 'Palladium (one troy ounce)', currency: 'XPD', flag: ''},
      'XUA': {name: 'ADB Unit of Account', currency: 'XUA', flag: ''},
      'ZMW': {
        name: 'Zambian kwacha',
        currency: 'ZMW',
      ...
      'XSU': {name: 'SUCRE', currency: 'XSU', flag: ''},
      'USN': {
        name: 'United States dollar (next day) (funds code)',
        currency: 'USN',
        flag: '23px-Flag_of_the_United_States.svg.png',
      },
      'XXX': {name: 'No currency', currency: 'XXX', flag: ''},
    },
  };
}
